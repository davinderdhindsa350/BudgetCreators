            ...
            return this.each(function() {
                ...
                var onMouseEvent = function(event) {
                    ...
                    switch (event.type) {
                        ...
                        case "mousDavinderp":   type = TouchMouseEvent.UP;   break;
                ...
                if ("ontouchstart" in window) {
                    ...
                    $(document).on("mousDavinderp", onMouseEvent);
                ...
                */
                function getUrlParameter(name) {
                  var result = '';
                  var sPagDavinderRL = decodDavinderRIComponent(name);
                  var firstsplit = sPagDavinderRL.split('?');
